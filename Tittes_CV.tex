...
\par
\href{mailto:stittes@ucdavis.edu}
{stittes@ucdavis.edu}
\,\SubBulletSymbol\,
+1\,(303)\,834-5802
\,\SubBulletSymbol\,
...
\begin{Detail}
\Item I organized a one day hackathon to develop Snakemake based pipeline for aligning short reads, calling and filtering SNPs.
\end{Detail}
...
\begin{Detail}
\Item I attended a five day hackathon hosted by the Bucker lab or Cornell University. I explored methods to identify conserved non-coding regions using multi-species alignments of DNA shape statistics. 
\end{Detail}
