...
\par
\href{mailto:stittes@ucdavis.edu}{stittes@ucdavis.edu}
\,\SubBulletSymbol\,
\href{https://github.com/silastittes}{https://github.com/silastittes}
\,\SubBulletSymbol\,
+1\,(303)\,834-5802
\,\SubBulletSymbol\,
\href{\CVWebpage}
...
%\begin{Detail}
%\Item
%Advisers: Prof.~Nolan~Kane, and Prof.~Nancy~Emery
%\end{Detail}
\begin{Detail}
\SubBulletItem
Dissertation:
...
%\begin{Detail}
%\Item
%Adviser: Prof.~Andrew~Martin
%\end{Detail}
\begin{Detail}
\SubBulletItem
Honors Thesis (\textit{Magna Cum Laude}):
...
\Gap
\BulletItem
Population Geneticist, Institute of Ecology and Evolution
\hfill
\DatestampYM{2022}{05} --
present 
%\begin{Detail}
%\Item
%Supervisor: Prof.~Andrew Kern
%\end{Datail}
...
\Gap
\BulletItem
Postdoctoral Researcher, Department of Evolution and Ecology
\hfill
\DatestampYM{2019}{05} --
\DatestampYM{2022}{05}
%\begin{Detail}
%\Item
%Supervisor: Prof.~Jeffrey Ross-Ibarra
%\end{Datail}
...
\begin{Detail}
\Item
CU Boulder, Ecology and Evolutionary Biology
\end{Detail}
...
\Gap
\BulletItem
Python package: \href{https://github.com/RILAB/mop}{\underline{mop}}
\hfill
\begin{Detail}
\Item Simple tool for capturing alignment regions with sufficient quality for genotyping.
\end{Detail}

\Gap
\BulletItem
R package: \href{https://github.com/silastittes/rdmc}{\underline{rdmc}}
\hfill
\begin{Detail}
\Item Implements convergent adaptation models of Lee and Coop (2017). 
\end{Detail}
...
\begin{Detail}
\Item A probablistic Hierarchical Bayesian model to predict performance curves across multiple groups (i.e. lines, populations, taxa, etc.). 
\end{Detail}
...
\Gap
\BulletItem
Phylogenetics / Comparative Biology, CU Boulder
\hfill
\DatestampY{Spring 2019}
...
\begin{Detail}
\Item I developed a series of R shiny based web applications used to teach undergraduate fundamental concepts in Population Genetics. These are free to use and available on \href{https://github.com/silastittes/shiny_popgen}{\underline{GitHub}}, and are used regularly in several population genetics courses in several countries.
\end{Detail}
...
\Section
{Hackathons, Workshops, and Meetups}
{Hackathons, Workshops, and Meetups}
{PDF:Hackathons, Workshops, and Meetups}

%\Gap
%\BulletItem
%(Organizer or attendants)
%\hfill
%\DatestampY{Moth Year}
%\begin{Detail}
%\Item What happened
%\end{Detail}
...
\Gap
\BulletItem
Ross-Ibarra Lab Snakefest (organizer), UC Davis
\hfill
\DatestampY{August 2019}
\begin{Detail}
\Item I organized a one day hackathon to develop a Snakemake based pipeline for aligning short reads, calling and filtering SNPs.
\end{Detail}

\Gap
\BulletItem
PanAnd (attendant), Cornell University
\hfill
\DatestampY{June 2019}
\begin{Detail}
\Item I attended a five day hackathon hosted by the Bucker lab at Cornell University. I explored methods to identify conserved non-coding regions using multi-species alignments of DNA shape statistics. 
\end{Detail}
...
\BulletItem
Workshop: msprime (attendant), UC Davis
\hfill
\DatestampY{December 2018}
\begin{Detail}
\Item I attended a three day workshop hosted led by Kevin Thornton introducing msprime and related tools for coalescent based population genetic simulations.
\end{Detail}
...
\Gap
\BulletItem
Meetup: R-ladies Boulder Meetup (attendant), Boulder, CO
\hfill
\DatestampY{Monthly (starting September 2019)}
\begin{Detail}
\Item I attend the monthly R-ladies Boulder Meetup to practice, learn, and develop new R language skills in an inclusive environment.
\end{Detail}
...
\Gap
\NumberedItem{[3]}
{M Elise Lauterbur, Mariz Izabel A Cavassim, ...,\underline{S Tittes}, ..., Ilan Gronau.
Expanding the stdpopsim species catalog, and lessons learned for realistic genome simulations (2022)
\textit{bioRxiv}}.


\Gap
\NumberedItem{[2]}
CCR Smith, \underline{S Tittes}, PL Ralph, AD Kern.
Dispersal inference from population genetic variation using a convolutional neural network (2022).
\textit{bioRxiv}}.

\Gap
\NumberedItem{[1]}
{\underline{S Tittes}, A Lorant, S McGinty, J Doebley, J Holland, J Sanchez-Gonzalez, A Seetharam, M Tenaillon, J Ross-Ibarra.
...
\Gap
\NumberedItem{[16]}
{MB Hufford, A Seetharam, \ldots, \underline{S Tittes},  \ldots, RK Dawe.
De novo assembly, annotation, and comparative analysis of 26 diverse maize genomes (2021).
\textit{Science}}.

\Gap
\NumberedItem{[15]}
{NB O'Hara, SJ Franks, NC Kane, \underline{S Tittes}, JS Rest.
Evolution of pathogen response genes associated with increased disease susceptibility during adaptation to an extreme drought event in a \textit{Brassica rapa} plant population (2021).
\textit{BMC Ecology and Evolution}}.
...
\Gap
\NumberedItem{[13]}
{R Wooliver, \underline{S Tittes}, SN Sheth.
...
\Gap
\NumberedItem{[12]}
{AA Comeault, J Wang, \underline{S Tittes}, K Isbell, S Ingley, AH Hurlbert, DR Matute.
...
(2019).
\textit{Journal of College Science Teaching}}.
...
(2016).
Current and future needs and applications for \textit{Cannabis}.
...
(2016).
Genomic and chemical diversity in \textit{Cannabis}.
\textit{Critical Reviews in Plant Sciences}}.
...
{\underline{S Tittes}.
(2020).
Evolutionary genetics of lots of grass.
\textit{UC Davis, Center for Population Biology, Seminar}},
remote
...
{\underline{S Tittes}.
(2020).
Local Adaptation in Maize landrace and \textit{parviglumis} populations.
\textit{Zeavolution}},
remote
